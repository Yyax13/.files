...
local colors = {
    ...
    black4 = "#6a2a2a", -- comments, muted
    black5 = "#0a0a0a", -- subtle accents

    -- reds
    red0 = "#aa0000", -- dark red (dimmed)
    red1 = "#aa0000", -- medium red
    red2 = "#aa0000", -- primary red
    red3 = "#cc1111", -- bright red (visual accent)
    red4 = "#dd2222", -- hot red (errors, bold)
